...
export const PATHS = {
  ...
  mainDictionarySourcePath: join(
    ROOT_DIR,
    'data/raw',
    SOURCES.mainDictionarySource,
  ),
  wordsJlptSourcePath: join(ROOT_DIR, 'data/raw', SOURCES.wordsJlptSource),
  literaryFrequenciesSourcePath: join(
    ROOT_DIR,
    'data/raw',
    SOURCES.literaryFrequenciesSource,
  ),
  spokenFrequenciesSourcePath: join(
    ROOT_DIR,
    'data/raw',
    SOURCES.spokenFrequenciesSource,
  ),
  tubelexOccurrencesSourcePath: join(
    ROOT_DIR,
    'data/raw',
    SOURCES.tubelexOccurrencesSource,
  ),
